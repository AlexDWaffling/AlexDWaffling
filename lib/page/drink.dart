...
class drinkTab extends StatelessWidget {
  ...
  drinkTab({Key? key, required this.cItem, required this.getFunc}) : super(key: key);
  
  final ProductsController _productsController = Get.put(ProductsController());
  
  @override
  Widget build(BuildContext context) {
    RxList<ProductItem> productsCtg = _productsController.getAllItemsByCategory('Drink');
